...
- [ ] 2. Implement form validation and file validation utilities
  - [ ] 2.1 Create `src/features/admin/events/validation.ts` with `validateEventForm` (checks required fields: title, type, date, venue) and `validateFile` (checks MIME type and size ≤ 10 MB)
  ...
  - [ ] 2.2 Write property test for event form validation (Property 2)
  ...
  - [ ] 2.3 Write property test for event type enum invariant (Property 3)
  ...
  - [ ] 2.4 Write property test for event status enum invariant (Property 4)
  ...
  - [ ] 2.5 Write property test for default status on creation (Property 9)
  ...
  - [ ] 2.6 Write property test for file type validation (Property 7)
  ...
  - [ ] 2.7 Write property test for file size validation (Property 8)
...
- [ ] 3. Implement custom hooks
  - [ ] 3.1 Create `useEvents.ts` — manages events list state, exposes `fetchEvents`, `createEvent`, `updateEvent`, `deleteEvent`, loading and error state
    - _Requirements: 1.1, 2.1, 2.3, 2.4_

  - [ ] 3.2 Write property test for status filter correctness (Property 5)
  ...
  - [ ] 3.3 Create `useParticipants.ts` — manages participant list state, exposes `fetchAvailable`, `assign`, `remove`, loading and error state
    - _Requirements: 3.1, 3.2, 3.3_

  - [ ] 3.4 Write property test for participant assignment round trip (Property 6)
  ...
  - [ ] 3.5 Create `useFileAttachments.ts` — manages attachment list state, exposes `upload`, `remove`, loading and error state
