...
export function AppRoutes() {
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/admin/dashboard", element: _jsx(ProtectedRoute, { children: _jsx(AdminDashboard, {}) }) }), _jsx(Route, { path: "/admin/students", element: _jsx(ProtectedRoute, { children: _jsx(Students, {}) }) }), _jsx(Route, { path: "/admin/faculty", element: _jsx(ProtectedRoute, { children: _jsx(Faculty, {}) }) }), _jsx(Route, { path: "/admin/reports", element: _jsx(ProtectedRoute, { children: _jsx(Reports, {}) }) }), _jsx(Route, { path: "/admin/instructions", element: _jsx(ProtectedRoute, { children: _jsx(Instructions, {}) }) }), _jsx(Route, { path: "/admin/events", element: _jsx(ProtectedRoute, { children: _jsx(EventsErrorBoundary, { children: _jsx(EventsPage, {}) }) }) }), _jsx(Route, { path: "/admin/scheduling", element: _jsx(ProtectedRoute, { children: _jsx(SchedulingPage, {}) }) }), _jsx(Route, { path: "/admin", element: _jsx(Navigate, { to: "/admin/dashboard", replace: true }) }), _jsx(Route, { path: "/", element: _jsx(Navigate, { to: "/admin/dashboard", replace: true }) })] }) }));
}
