                ...
                >
                  ...
                  <div className="space-y-1.5">
                    {daySchedules.length === 0 ? (
                      ...
                      daySchedules.map((s) => (
                        <CalendarCell key={s.id} schedule={s} onEdit={onEdit} onDelete={onDelete} compact readOnly={readOnly} />
                      ))
                    )}
                  </div>
                </div>
            ...
            <div key={day.toISOString()} className="space-y-2">
              ...
              <div className="space-y-2 min-h-[200px]">
                {daySchedules.length === 0 ? (
                  ...
                  daySchedules.map((s) => (
                    <CalendarCell key={s.id} schedule={s} onEdit={onEdit} onDelete={onDelete} readOnly={readOnly} />
                  ))
                )}
              </div>
            </div>
