            ...
            case 'research':
                return [
                    ...
                    },
                    {
                        key: 'type',
                        header: 'Type',
                        render: (row) => (_jsx("span", { className: "capitalize px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-medium", children: row.type }))
                    },
                    {
                        key: 'status',
                        header: 'Status',
                    ...
                    },
                    {
                        key: 'completion_date',
                        header: 'Completion',
                        render: (row) => row.completion_date ? new Date(row.completion_date).toLocaleDateString() : 'N/A'
                    }
                ];
            case 'events':
                return [
