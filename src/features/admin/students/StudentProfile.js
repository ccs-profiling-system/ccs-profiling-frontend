...
function ActivitiesTab({ studentId }) {
    ...
    if (activities.length === 0) {
        return (_jsxs("div", { className: "text-center py-10", children: [_jsx("p", { className: "text-gray-500 text-sm", children: "No activities recorded for this student." }), _jsx("p", { className: "text-gray-400 text-xs mt-1", children: "Activities are auto-linked when the student is added as a participant in an event." })] }));
    }
