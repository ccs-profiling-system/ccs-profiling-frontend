...
// ── Arbitraries ──────────────────────────────────────────────────────────────
const validStatus = fc.constantFrom(...VALID_EVENT_STATUSES);
...
describe('hooks.test.ts — property-based tests', () => {
    ...
    it('Property 5: filtered result contains only events matching the selected status', () => {
        ...
        fc.assert(fc.property(fc.array(arbitraryEvent, { minLength: 0, maxLength: 20 }), validStatus, (events, filterValue) => {
    ...
    it('Property 6: after assign, the participant list contains exactly the submitted IDs', () => {
        ...
        fc.assert(fc.property(fc.array(arbitraryParticipant, { minLength: 0, maxLength: 10 }), (participants) => {
            ...
            return (reconciledIds.length === sortedSubmitted.length &&
