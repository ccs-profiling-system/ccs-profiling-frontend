...
describe('StudentDashboard', () => {
    ...
    it('renders loading state initially', () => {
        vi.mocked(studentService.getProfile).mockImplementation(() => new Promise(() => { }) // Never resolves
        );
        vi.mocked(courseService.getEnrolledCourses).mockImplementation(() => new Promise(() => { }) // Never resolves
        );
        render(_jsx(BrowserRouter, { children: _jsx(AuthProvider, { children: _jsx(StudentDashboard, {}) }) }));
