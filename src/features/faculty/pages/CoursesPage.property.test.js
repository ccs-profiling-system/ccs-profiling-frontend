...
function renderCoursesPage() {
    return render(_jsx(MemoryRouter, { children: _jsx(CoursesPage, {}) }));
}
...
describe('Property 8: Courses page renders all required course fields', () => {
    ...
    it('renders course code, name, section, semester, year, and schedule for every course', async () => {
        await fc.assert(fc.asyncProperty(fc.array(facultyCourseArb, { minLength: 1, maxLength: 6 }), teachingLoadArb, async (courses, teachingLoad) => {
