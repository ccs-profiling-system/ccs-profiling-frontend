 ...
 */
export function extractArray(response, fallback = []) {
 ...
 * }
 */
export function createTypeGuard(predicate) {
 ...
 */
export function safeMap(value, callback, fallback = []) {
 ...
 */
export function safeFilter(value, predicate, fallback = []) {
    if (!Array.isArray(value)) {
