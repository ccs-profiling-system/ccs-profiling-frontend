    ...
    <>
      ...
      <aside
        className={`
          ...
          w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-2xl flex flex-col
      ...
      >
        ...
        <div className="p-4 border-t border-slate-700/50">
          ...
          <p className="text-xs text-slate-500 text-center mt-4">© 2026 CCS System</p>
        </div>
      </aside>
    </>
  );
